...
public class ArchaeopteryxCameraScript : MonoBehaviour {
	public GameObject target;
	public GameObject archaeopteryxCamera;
	...
	void Update(){
		...
		archaeopteryxCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
