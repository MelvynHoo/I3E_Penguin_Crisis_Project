...
public class PoisonDartFrogCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject poisonDartFrogCamera;
	...
	void Update(){
		...
		poisonDartFrogCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
